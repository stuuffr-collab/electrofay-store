...
-- ============================================================================
-- Advanced offers system with 5 offer types and relational design
-- Types: product_discount, bundle, buy2_get3_half, free_shipping_threshold, coupon
-- ============================================================================
...
-- Performance Indexes
CREATE INDEX IF NOT EXISTS idx_offers_active ON public.offers(is_active, ends_at) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_offers_featured ON public.offers(is_featured, priority) WHERE is_featured = TRUE;
...
-- RLS Policies: Public can read active, non-deleted offers
CREATE POLICY "Allow public read access to active offers" ON public.offers
    FOR SELECT USING (is_active = TRUE AND deleted_at IS NULL);

-- RLS Policies: Public can read offer_products for active offers
